...
<script src="https://cdn.jotfor.ms/s/umd/d21a0975090/for-form-branding-footer.js" type="text/javascript" defer></script>
...
<script type="text/javascript">	JotForm.newDefaultTheme = true;
	...
	window.addEventListener('DOMContentLoaded',function(){window.brandingFooter.init({"formID":253458600123046,"campaign":"powered_by_jotform_le","isCardForm":false,"isLegacyForm":true,"formLanguage":"en"})});	JotForm.isFullSource = true;
...
if (window.JotForm && JotForm.accessible) $('input_5').setAttribute('tabindex',0);
   ...
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,{"name":"q1_header","qid":"1","text":"Prayer Request Submission Form","type":"control_head"},{"description":"","name":"q2_fullname0","qid":"2","text":"First Name","type":"control_fullname"},null,{"description":"","name":"q4_email2","qid":"4","subLabel":"example@example.com","text":"Email Address","type":"control_email"},{"description":"","mde":"No","name":"q5_textarea3","qid":"5","subLabel":"","text":"Please describe your prayer request in detail","type":"control_textarea","wysiwyg":"Disable"},{"name":"q6_submit","qid":"6","text":"Submit Prayer Request","type":"control_button"}]);}, 20); 
</script>
...
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/themes/CSS/5e6b428acc8c4e222d1beb91.css?v=3.3.67327&themeRevisionID=65660e4b326633110492e01a"/>
...
div.form-subHeader {color: #000000 !important;}
label.form-sub-label {color: #1565c0 !important;}
input::placeholder, textarea::placeholder {color: #000000 !important; opacity: 1 !important;}
    /* Injected CSS Code */
</style>

<form class="jotform-form" onsubmit="return typeof testSubmitFunction !== 'undefined' && testSubmitFunction();" action="https://submit.jotform.com/submit/253458600123046" method="post" name="form_253458600123046" id="253458600123046" accept-charset="utf-8" autocomplete="on"><input type="hidden" name="formID" value="253458600123046" /><input type="hidden" id="JWTContainer" value="" /><input type="hidden" id="cardinalOrderNumber" value="" /><input type="hidden" id="jsExecutionTracker" name="jsExecutionTracker" value="build-date-1765771071520" /><input type="hidden" id="submitSource" name="submitSource" value="unknown" /><input type="hidden" id="submitDate" name="submitDate" value="undefined" /><input type="hidden" id="buildDate" name="buildDate" value="1765771071520" /><input type="hidden" name="uploadServerUrl" value="https://upload.jotform.com/upload" /><input type="hidden" name="eventObserver" value="1" />
  <div role="main" class="form-all">
    <ul class="form-section page-section" role="presentation">
      <li id="cid_1" class="form-input-wide" data-type="control_head">
        <div style="display:table;width:100%">
          <div class="form-header-group hasImage header-default" data-imagealign="Left">
            <div class="header-logo"><img src="https://www.jotform.com/uploads/dessy473abr/form_files/logo.693ccff32152b6.14222159.jpg" alt="Prayer Request Submission Form" width="100" class="header-logo-left" /></div>
            <div class="header-text httac htvam">
              <h2 id="header_1" class="form-header" data-component="header">Prayer Request Submission Form</h2>
              <div id="subHeader_1" class="form-subHeader">Psalms 55:22 &quot;Cast your cares, unto the Lord and He will sustain you.&quot;</div>
            </div>
          </div>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_fullname" id="id_2"><label class="form-label form-label-top form-label-auto" id="label_2" for="first_2" aria-hidden="false"> First Name<span class="form-required">*</span> </label>
      ...
      <li class="form-line jf-required" data-type="control_textarea" id="id_5"><label class="form-label form-label-top form-label-auto" id="label_5" for="input_5" aria-hidden="false"> Please describe your prayer request in detail<span class="form-required">*</span> </label>
      ...
      <li class="form-line" data-type="control_button" id="id_6">
        <div id="cid_6" class="form-input-wide" data-layout="full">
          <div data-align="auto" class="form-buttons-wrapper form-buttons-auto   jsTest-button-wrapperField"><button id="input_6" type="submit" class="form-submit-button form-submit-button-gradient-12 submit-button jf-form-buttons jsTest-submitField legacy-submit" data-component="button" data-content="">Submit Prayer Request</button></div>
        </div>
      </li>
  ...
  </script><input type="hidden" class="simple_spc" id="simple_spc" name="simple_spc" value="253458600123046" />
  <script type="text/javascript">
    var all_spc = document.querySelectorAll("form[id='253458600123046'] .si" + "mple" + "_spc");
    for (var i = 0; i < all_spc.length; i++)
    {
      all_spc[i].value = "253458600123046-253458600123046";
    }
  </script>
</form>
<link id=color-scheme-style href="https://cdn.jotfor.ms/stylebuilder/static/color-scheme.css?v=3.3.67327" type="text/css" rel="stylesheet" /><script type="text/javascript">JotForm.ownerView=true;</script><script type="text/javascript">JotForm.isNewSACL=true;</script>
